...
function deracer_handler (eh,mev) {                    /* line 41 */
    ...
    if ( inst.state ==  "idle") {                      /* line 43 */
      ...
      if ( "1" ==  mev.port) {                         /* line 54 */
        ...
        runtime_error ( ( "deracer: waiting for 1 but got ;".toString ()+ strcons ( mev.port, "' (case B)").toString ()) )/* line 59 *//* line 60 */
      }
    }
      ...
      if ( "2" ==  mev.port) {                         /* line 62 */
        ...
        runtime_error ( ( "deracer: waiting for 2 but got '".toString ()+ strcons ( mev.port, "' (case C)").toString ()) )/* line 67 *//* line 68 */
      }
    }
    else {                                             /* line 69 */
